	...
	<div class="wrapper">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img
						...
						class="user-image" alt="User Image"> <span class="hidden-xs">${udername}	
						
					<c:out value="${udername}"></c:out>
						</span>
				</a>
					<ul class="dropdown-menu">
						<!-- User image -->
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-pie-chart"></i>
				...
				<ul class="treeview-menu">
					<li><a href="/SpringMVCHibernateCRUDExample/depment"><i
							class="fa fa-circle-o"></i>regin nghi phep</a></li>
