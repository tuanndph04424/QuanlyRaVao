...
<link
	href="<c:url value="/resources/bootstrap/tablebootstrap/table.css" />"
	rel="stylesheet">
<link rel="stylesheet"
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-laptop"></i>
				...
				<ul class="treeview-menu">
					<li><a href="/QuanLyRaVao/home/timein"><i
							class="fa fa-circle-o"></i>Time In</a></li>
					<li><a href="/QuanLyRaVao/home/timeout"><i
							class="fa fa-circle-o"></i>Time Out</a></li>
					<li><a href="/QuanLyRaVao/home/regithdayoff"><i
							class="fa fa-circle-o"></i> regithdayoff</a></li>

					<li><a href="/QuanLyRaVao/home/showUserTimeInOut"><i
							class="fa fa-circle-o"></i> UserTimeIn/Out</a></li>
				</ul></li>
			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>Department/Roles</span> <i class="fa fa-angle-left pull-right"></i>
			</a>
				<ul class="treeview-menu">
					<li><a href="/QuanLyRaVao/home/roles"><i
							class="fa fa-circle-o"></i> Roles</a></li>


					<li><a href="/QuanLyRaVao/home/department"><i
							class="fa fa-circle-o"></i>Department</a></li>

					<li><a href="/QuanLyRaVao/home/userroles"><i
							class="fa fa-circle-o"></i>UserRoles</a></li>
			...
			<li class="treeview"><a href="#"> <i class="fa fa-table"></i>
				...
				<ul class="treeview-menu">
					...
					<li><a href="/QuanLyRaVao/home/usertimeout"><i
							class="fa fa-circle-o"></i> ManagerApproval</a></li>

						<li><a href="/QuanLyRaVao/home/userDirectorApprovalTimeOut"><i
							class="fa fa-circle-o"></i> DirectorApproval</a></li>
		...
		<!-- Content Wrapper. Contains page content -->
		<div class="content-wrapper" style="width: 1110px; height: 900px">
