...
<form:form action="/QuanLyRaVao/home/updateManagertimeout" onsubmit="return validateForm()" name="myForm"
	...
	<div style="">
		...
		<div
			...
			<form:textarea path="ManagerApprovalCanel" rows="5"
				style="width: 565px"  />

		<div id="ManagerApprovalCanel1" style="color: red;clear: both"></div>
			...
			%>
			<form:input path="ManagerApproval.ID"
