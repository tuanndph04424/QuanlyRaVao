	...
	<tiles:putAttribute name="content">
		...
		<script>
			...
			function myFunction2(id) {
				$.get("cannertimeout/" + id, function(data, status) {
					document.getElementById("showmodal1").innerHTML = data;
				});
			}
			function validateForm() {
				
				var ManagerApprovalCanel = document.forms["myForm"]["ManagerApprovalCanel"].value;
				
				if (ManagerApprovalCanel == "") {

					document.getElementById("ManagerApprovalCanel1").innerHTML = " Not Null";
					return false;
				}
			}
		</script>
