			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form:form action="/QuanLyRaVao/home/addroles" method="POST" 	onsubmit="return validateForm()" name="myForm"
							commandName="addrole" class="well form-horizontal">
		...
		<div class="modal fade" id="Edit" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form:form action="/QuanLyRaVao/home/updateroles" method="POST"
							commandName="addrole" class="well form-horizontal">
